...
object FieldValidator {
  ...
  val isContainedIn: Iterable[String] => String => Boolean =
    (iterable: Iterable[String]) => (input: String) => iterable.exists(_ == input.trim)

  val isContainedInIgnoreCase: Iterable[String] => String => Boolean =
    (iterable: Iterable[String]) => (input: String) => iterable.exists(_.toUpperCase == input.trim.toUpperCase)
