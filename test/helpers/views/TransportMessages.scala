...
trait TransportMessages {
  ...
  val modeOfTransportSea = modeOfTransport + ".sea"
  val modeOfTransportRail = modeOfTransport + ".rail"
  val modeOfTransportRoad = modeOfTransport + ".road"
  val modeOfTransportAir = modeOfTransport + ".air"
  val modeOfTransportPostalOrMail = modeOfTransport + ".postalOrMail"
  val modeOfTransportFixed = modeOfTransport + ".fixed"
  val modeOfTransportInland = modeOfTransport + ".inlandWaterway"
  val modeOfTransportOther = modeOfTransport + ".other"
