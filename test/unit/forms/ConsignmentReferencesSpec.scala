  ...
  "Consignment References mapping" should {
    ...
    "convert ducr to upper case" in {
      val form = ConsignmentReferences
        .form(depart)
        .bind(Json.obj("reference" -> "D", "ducrValue" -> "8gb123457359100-test0001"), JsonBindMaxChars)
    ...
    "convert mucr to upper case" in {
      val form = ConsignmentReferences
        .form(arrive)
        .bind(Json.obj("reference" -> "M", "mucrValue" -> "gb/abced1234-15804test"), JsonBindMaxChars)
