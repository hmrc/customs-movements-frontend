...
class LocationViewSpec extends ViewSpec with Injector {
  ...
  private val view: Html = locationPage(form, Some("some-reference"))
  ...
  "Location View on empty page" should {
    ...
    "have the correct section header for the Departure journey" in {
      ...
      val departureView = locationPage(form, Some("some-reference"))(journeyRequest(DepartureAnswers()), messages)
